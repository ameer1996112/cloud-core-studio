...
describe("app marketing contracts", () => {
  ...
  test("resolves explicit, saved, accepted language, then Arabic fallback", () => {
    ...
    expect(resolveMarketingLocale({ accepted: "en-US;q=0.2,en;q=0.9,he;q=0.5" })).toBe("en");
    expect(resolveMarketingLocale({ accepted: "en-US;q=0.9,en;q=0.2,he;q=0.5" })).toBe("en");
    expect(resolveMarketingLocale({ accepted: "en-US;q=0.5,en;q=0.5,he;q=0.5" })).toBe("en");
    expect(resolveMarketingLocale({ accepted: "he;q=0.5,en-US;q=0.5,en;q=0.5" })).toBe("he");
