...
const PROGRAM_ACCENTS = {
  aerial: {
    key: "aerial",
    rail: "var(--cc-lesson-aerial-rail)",
    wash: "var(--cc-lesson-aerial-wash)",
    surface: "var(--cc-lesson-aerial-surface)",
    icon: "cloud",
  },
  mat: {
    key: "mat",
    rail: "var(--cc-lesson-mat-rail)",
    wash: "var(--cc-lesson-mat-wash)",
    surface: "var(--cc-lesson-mat-surface)",
    icon: "mat",
  },
  hot: {
    key: "hot",
    rail: "var(--cc-lesson-hot-rail)",
    wash: "var(--cc-lesson-hot-wash)",
    surface: "var(--cc-lesson-hot-surface)",
    icon: "heat",
  },
  default: {
    key: "default",
    rail: "var(--cc-lesson-default-rail)",
    wash: "var(--cc-lesson-default-wash)",
    surface: "var(--cc-lesson-default-surface)",
    icon: "spark",
  },
} as const;
