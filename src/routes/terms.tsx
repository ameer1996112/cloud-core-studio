...
const copy: Record<Lang, { title: string; kicker: string; updated: string; sections: string[] }> = {
  en: {
    ...
    sections: [
      ...
      "A package is supplied digitally to the member account after payment approval, normally immediately. If provider review is required, activation may take up to one business day. No physical product is shipped.",
      ...
      "Participation in physical activity is at the participant's responsibility and must be appropriate to their health and ability. The studio is not liable for indirect loss, provider outages, or misuse of the service, except where liability cannot legally be excluded.",
  ...
  he: {
    ...
    sections: [
      ...
      "החבילה מסופקת באופן דיגיטלי לחשבון הלקוח לאחר אישור התשלום, בדרך כלל באופן מיידי. אם נדרשת בדיקת ספק, ההפעלה עשויה להימשך עד יום עסקים אחד. לא נשלח מוצר פיזי.",
      ...
      "השתתפות בפעילות גופנית היא באחריות המשתתף ובהתאם למצבו הבריאותי וליכולתו. הסטודיו לא יישא באחריות לנזק עקיף, לתקלת ספק או לשימוש שאינו בהתאם להנחיות, למעט אחריות שלא ניתן להגביל לפי דין.",
  ...
  ar: {
    ...
    sections: [
      ...
      "تُفعّل الباقة رقميًا في حساب العضو بعد اعتماد الدفع، وعادةً فورًا. إذا احتاج مزود الدفع إلى مراجعة فقد يستغرق التفعيل حتى يوم عمل واحد. لا يتم شحن منتج مادي.",
      ...
      "المشاركة في النشاط البدني مسؤولية المشارك ووفق حالته الصحية وقدرته. لا يتحمل الاستوديو ضررًا غير مباشر أو تعطل مزود أو استخدامًا مخالفًا للتعليمات، باستثناء المسؤولية التي لا يجوز تقييدها قانونًا.",
