...
function localizeActivityAction(action: string, lang: "en" | "he" | "ar"): string {
  const ACTION_MAP: Record<string, Record<string, string>> = {
    ...
    "booking.member_cancel": {
      he: "ביטול עצמי (מתאמן/ת)",
      ar: "إلغاء ذاتي (متدرب/ة)",
      en: "Member self-cancel",
    },
    ...
    "waitlist.offered": {
      he: "הצעת מקום מהמתנה",
      ar: "عرض مقعد قائمة الانتظار",
      en: "Waitlist spot offered",
    },
    "waitlist.promoted": {
      he: "קידום מרשימת המתנה",
      ar: "ترقية من قائمة الانتظار",
