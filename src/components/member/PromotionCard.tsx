...
export function PromotionCard({
  ...
  return (
    <aside
      dir={dir}
      className="relative mt-5 overflow-hidden rounded-[1.75rem] border border-gold/55 bg-navy px-5 py-6 text-ivory shadow-[0_22px_60px_var(--cc-alpha-yoga-promo-shadow)] sm:px-7 sm:py-7"
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 opacity-70 [background:radial-gradient(circle_at_12%_15%,var(--cc-alpha-gold-22),transparent_25%),radial-gradient(circle_at_88%_82%,var(--cc-alpha-white-38),transparent_30%)]" />
      <div className="relative grid gap-5 pe-6 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center">
        <div>
          ...
          <h2 className="font-display text-2xl leading-tight text-ivory sm:text-3xl">
            {displayCopy.title}
          </h2>
          <p className="mt-2 max-w-2xl text-sm leading-6 text-ivory/82 sm:text-base">
            {displayCopy.body}
          </p>
        ...
        {canClaim ? (
          <button
            ...
            className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-gold bg-gold px-5 text-sm font-bold text-navy transition hover:bg-gold-soft disabled:cursor-wait disabled:opacity-65"
          >
            {displayCopy.cta}
          ...
          <a
            ...
            className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-gold/65 px-5 text-sm font-bold text-ivory transition hover:bg-white/10"
          >
            {displayCopy.cta}
            <ArrowLeft className="h-4 w-4 rtl:rotate-0 ltr:rotate-180" aria-hidden="true" />
          </a>
