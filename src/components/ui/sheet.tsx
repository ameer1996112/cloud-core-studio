  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        {...props}
      >
        <SheetPrimitive.Close className="absolute end-4 top-[max(1rem,calc(env(safe-area-inset-top)+0.5rem))] z-20 inline-flex h-11 w-11 items-center justify-center rounded-[var(--radius-pill)] bg-ivory/90 text-[var(--color-text-muted)] shadow-sm ring-offset-background backdrop-blur-sm cursor-pointer transition-[background-color,color,opacity] duration-200 hover:bg-gold/8 hover:text-navy focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-navy disabled:pointer-events-none data-[state=open]:bg-ivory/90">
          <X className="h-4 w-4" />
