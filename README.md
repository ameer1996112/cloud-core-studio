...
gcloud builds submit \
  --substitutions _IMAGE="$IMAGE",_VITE_SUPABASE_PROJECT_ID="$VITE_SUPABASE_PROJECT_ID",_VITE_SUPABASE_URL="$VITE_SUPABASE_URL",_VITE_SUPABASE_PUBLISHABLE_KEY="$VITE_SUPABASE_PUBLISHABLE_KEY"
```
