...
var nativeBridge = (function (exports) {
  ...
  const createProxyUrl = (url, win) => {
    ...
    const bridgeUrl = new URL(
      (_b = (_a = win.Capacitor) === null || _a === void 0 ? void 0 : _a.getServerUrl()) !== null &&
        _b !== void 0
        ? _b
        : "",
    );
  ...
  const initBridge = (w) => {
    ...
    const initEvents = (win, cap) => {
      cap.addListener = (pluginName, eventName, callback) => {
        ...
        return {
          remove: async () => {
            var _a;
            (_a = win === null || win === void 0 ? void 0 : win.console) === null || _a === void 0
              ? void 0
              : _a.debug("Removing listener", pluginName, eventName);
    ...
    const initVendor = (win, cap) => {
      ...
      IonicWebView.getServerBasePath = (callback) => {
        var _a;
        (_a = Plugins === null || Plugins === void 0 ? void 0 : Plugins.WebView) === null ||
        _a === void 0
          ? void 0
          : _a.getServerBasePath().then((result) => {
      ...
      if (platform == "android" || platform == "ios") {
          ...
          Object.defineProperty(document, "cookie", {
            get: function () {
              ...
              if (platform === "ios") {
                ...
                return (_c =
                  (_b =
                    (_a = win.CapacitorCookiesDescriptor) === null || _a === void 0
                      ? void 0
                      : _a.get) === null || _b === void 0
                    ? void 0
                    : _b.call(document)) !== null && _c !== void 0
                  ? _c
                  : "";
              }
            },
        ...
        if (doPatchHttp) {
          ...
          window.fetch = async (resource, options) => {
            ...
            if (
              (options === null || options === void 0 ? void 0 : options.body) instanceof
                FormData &&
                ...
                convertBody(body).then(({ data, type, headers }) => {
                  ...
                  if (body instanceof FormData) {
                    if (!this._headers["Content-Type"] && !this._headers["content-type"]) {
                      otherHeaders = Object.assign(Object.assign({}, otherHeaders), {
                      ...
                      if (this.readyState == 2) {
                        ...
                        this.responseText = (
                          (_a =
                            ...
                            nativeResponse.headers["content-type"]) === null || _a === void 0
                            ? void 0
      ...
      cap.toNative = (pluginName, methodName, options, storedCallback) => {
        ...
        try {
          if (typeof postToNative === "function") {
            ...
            (_a = win === null || win === void 0 ? void 0 : win.console) === null || _a === void 0
              ? void 0
              : _a.warn(`implementation unavailable for: ${pluginName}`);
          }
        } catch (e) {
          (_b = win === null || win === void 0 ? void 0 : win.console) === null || _b === void 0
            ? void 0
            : _b.error(e);
        }
        return null;
