...
END;$$;
REVOKE ALL ON FUNCTION public.admin_waitlist_offer(uuid, uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.admin_waitlist_offer(uuid, uuid) TO service_role;
